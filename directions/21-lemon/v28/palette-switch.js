...
(function () {
  ...
  var pages = [
    ...
    { href: 'homepage.html', label: 'V28 · Persona Quiz', klass: 'ps-current' },
    { href: 'nora-app/?p=SP1&s=TX&a=35&x=M&pg=0&c=none', label: 'V28 · Nora App', klass: 'ps-current' },
    { href: '../v27/homepage.html', label: 'V27 · Quality', klass: 'ps-archive' },
