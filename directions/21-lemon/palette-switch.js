...
(function () {
  ...
  var pages = [
    ...
    { href: 'homepage-v23-persona-quiz.html',   label: 'V23 · Persona Quiz', klass: 'ps-current' },
    { href: 'nora-app-v23/?p=SP1&s=TX&a=35&x=M&pg=0&c=none', label: 'V23 · Nora App', klass: 'ps-current' },
