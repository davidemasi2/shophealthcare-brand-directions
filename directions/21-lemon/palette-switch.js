...
(function () {
  ...
  var pages = [
    ...
    { href: 'homepage-v25-persona-quiz.html',   label: 'V25 · Persona Quiz', klass: 'ps-current' },
    { href: 'nora-app-v25/?p=SP1&s=TX&a=35&x=M&pg=0&c=none', label: 'V25 · Nora App', klass: 'ps-current' },
